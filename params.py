...
def generate_config_dict(args, isserver):
    ...
    if(isserver):
        ...
        if hasattr(args, 'smooth_method') and args.fairness_attribs is not None:
        ...
        if hasattr(args, 'aggregator_rf') and  args.fairness_attribs is not None:
    ...
    if args.model == "random_forest" :
        config_dict["random_forest"] = {
            ...
            "smoothedWeights_baseline_type" : args.smoothedWeights_baseline_type,
            "beta_fairness_trade_off" : args.beta_fairness_trade_off
        }
